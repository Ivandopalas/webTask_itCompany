...
<head>
  ...
  <fmt:message bundle="${loc}" key="local.text.table.createProject" var="create_project"/>
  <fmt:message bundle="${loc}" key="local.text.table.alreadyCreated" var="project_created"/>
  <fmt:message bundle="${loc}" key="local.text.table.jobDescription" var="job_description"/>
  <fmt:message bundle="${loc}" key="local.action.button.createProject" var="create_project_button"/>
...
<print_orders:manager_print allOrders="${requestScope.order_list}"/>
</body>
</html>
