...
<head>
  ...
  <fmt:message bundle="${loc}" key="local.text.table.showClients" var="show_clients"/>
  <fmt:message bundle="${loc}" key="local.action.button.showClients" var="show_clients_button"/>
</head>
  ...
  <tr>
    ...
    <td align="right">
      <form action="<%=request.getContextPath()%>/controller" method="post" >
        ...
        <input type="hidden" name="page_name" value="WEB-INF/jsp/manager/main.jsp">
...
<form action="<%=request.getContextPath()%>/controller" method="post" class="bootstrap-frm">
  <label>
   ...
   <!-- delete? <input type="hidden" name="ref_page" value="WEB-INF/jsp/addOrder.jsp"> -->
    <span>${show_clients}</span>
    <input type="submit" value="${show_clients_button}" class="button"/>
  </label>
</form>
</body>
</html>
