...
<head>
  ...
  <fmt:message bundle="${loc}" key="local.text.header.regError" var="regEr_header"/>

  <title>${regEr_header}</title>
</head>
...
<tabel align="right">
  <tr><td>
    <form action="<%=request.getContextPath()%>/controller" method="post" >
      ...
      <input type="hidden" name="page_name" value="WEB-INF/jsp/regFail.jsp">
...
<form action="<%=request.getContextPath()%>/controller" method="post" class="bootstrap-frm">
  ...
  <table align="center" border="0">
    <tr>
      <td><input type="submit" value=${index_button} class="button"/></td>
