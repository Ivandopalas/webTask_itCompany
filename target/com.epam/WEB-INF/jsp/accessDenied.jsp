...
<head>
  ...
  <fmt:message bundle="${loc}" key="local.text.header.accessDenied" var="header_access"/>
  <fmt:message bundle="${loc}" key="local.action.button.indexPage" var="index_page_button"/>



  <title>${header_access}</title>
</head>
<body>
<tabel align="right">
  <tr><td>
    <form action="<%=request.getContextPath()%>/controller" method="post" >
      ...
      <input type="hidden" name="page_name" value="WEB-INF/jsp/accessDenied.jsp">
...
<form action="<%=request.getContextPath()%>/controller" method="post" class="bootstrap-frm">
  ...
  <table align="center" border="0">
    <tr>
      <td><input type="submit" value="${index_page_button}" class="button"/></td>
    </tr>
